...
import 'package:roam_assist/views/locations_screen.dart';
...
class MapChoiceScreen extends StatefulWidget {
  ...
  @override
  State<MapChoiceScreen> createState() => _MapChoiceScreenState();
}


class _MapChoiceScreenState extends State<MapChoiceScreen> {
                      ...
                      child: SizedBox(
                          ...
                          child: DropdownButtonFormField<String>(
                              ...
                              onChanged: (map) async {
                                ...
                                // String s4 = "";
                                // if(widget.maps.toString() == "maps") {
                                //   s4 = "rooms:stairs";
                                // } else {
                                //   s4 = "home,work:mall,doctor,laundry";
                                // }
                                print(s4);
                                setState(()  {
                                  selectedMap = map;
